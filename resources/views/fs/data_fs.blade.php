        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-lg-6" align="left">
               <button class="btn btn-success" data-toggle="modal" data-target="#myData"><i class="fa fa-plus"></i> Catat</button>
            </div>
          </div>
         <br><br>
          @endif
          <div class="table-responsive">
        	...
        	<table id="myTable" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  @if((Session::get('akses') == "super") OR (Session::get('akses') == "admin"))
                  <td>
                    <abbr title="Edit"><a class="btn btn-primary" data-toggle="modal" data-target="#myEdit{{ $o->id_fs }}"><i class="fa fa-pencil"></i></a></abbr> 
                  </td>
                  @endif
                </tr>
                @endforeach
