...
<!-- ......................................................................... -->      
        ...
        {{ Request::is('stok/AA0104F')?'active':null}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('stok/AA0102')?'active':null}}"><a href="{{URL('stok/AA0102')}}"><i class="fa fa-angle-double-right"></i> <span>Bisma BMM</span></a></li>
...
<!-- ........................................................................... -->
        ...
        {{ Request::is('in/masuk/'.$now.'/AA0104F')?'active':null}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('in/masuk/'.$now.'/AA0102')?'active':null}}"><a href="{{URL('in/masuk/'.$now.'/AA0102')}}"><i class="fa fa-angle-double-right"></i> <span>Bisma BMM</span></a></li>
...
<!-- ......................................................................... -->      
        ...
        {{ Request::is('out/keluar/'.$now.'/AA0104F')?'active':null}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('out/keluar/'.$now.'/AA0102')?'active':null}}"><a href="{{URL('out/keluar/'.$now.'/AA0102')}}"><i class="fa fa-angle-double-right"></i> <span>Bisma BMM</span></a></li>
...
<!-- ......................................................................... -->      
        ...
        {{ Request::is('sale/jual/'.$now.'/AA0104F')?'active':null}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('sale/jual/'.$now.'/AA0102')?'active':null}}"><a href="{{URL('sale/jual/'.$now.'/AA0102')}}"><i class="fa fa-angle-double-right"></i> <span>Bisma BMM</span></a></li>
...
<!-- ......................................................................... -->      
        ...
        {{ Request::is('opname/stok/'.$now.'/AA0104F')?'active':null}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('opname/stok/'.$now.'/AA0102')?'active':null}}"><a href="{{URL('opname/stok/'.$now.'/AA0102')}}"><i class="fa fa-angle-double-right"></i> <span>Bisma BMM</span></a></li>
