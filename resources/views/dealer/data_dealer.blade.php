          ...
          <div class="table-responsive">
        	<table id="myTable" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  <td>
                    @if(Session::get('akses') == "super")
                    <abbr title="Edit"><button class="btn btn-flat btn-primary" data-toggle="modal" data-target="#myEdit{{ $o->id_dealer }}"><i class="fa fa-pencil"></i></button></abbr>
                    @endif
                    ...
                    @if(Session::get('akses') == "super")
                    <abbr title="Hapus"><a href="{{URL('dealer/delete',$o->id_dealer)}}" class="btn btn-flat btn-danger" onclick="return tanya('Yakin hapus data {{ $o->username }}?')"><i class="fa fa-trash"></i></a></abbr>
                    @endif
                  </td>
                </tr>
                @endforeach
