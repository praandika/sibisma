...
<div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <button class="btn btn-flat btn-success" data-toggle="modal" data-target="#myData"><i class="fa fa-plus"></i> Tambah</button><br><br>
          <div class="table-responsive">
        	<table id="myTable" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                	...
                	<td>{{ $o->dealer }}</td>
                  <td>
                    <abbr title="Edit"><button class="btn btn-flat btn-primary" data-toggle="modal" data-target="#myEdit{{ $o->id }}"><i class="fa fa-pencil"></i></button></abbr>
                    ...
                    <abbr title="Hapus"><a href="{{URL('admin/delete',$o->id)}}" class="btn btn-flat btn-danger" onclick="return tanya('Yakin hapus data {{ $o->username }}?')"><i class="fa fa-trash"></i></a></abbr>
                  </td>
                </tr>
                @endforeach
                </tbody>
  ...
  <div class="modal-dialog">
            ...
            <div class="col-lg-6">
              <div class="form-group has-feedback">
                <select class="form-control" name="dealer" required="required">
                    ...
                    <option value="{{ $o->dealer }}">Dealer : Bisma BMM</option>
                    ...
                    <option value="AA0102">Bisma BMM</option>
    ...
    <!-- End Modal Body -->
        ...
        <div class="modal-footer">
          <button class="btn btn-flat btn-primary" type="submit" name="add"><i class="fa fa-floppy-o"></i> Ubah</button>
