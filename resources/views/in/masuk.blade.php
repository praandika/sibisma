        ...
        <div class="box-body">
          ...
          <div class="row hidden-xs">
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
              <a class="btn btn-info btn-flat" href="{{ URL('in/riwayat',$home)}}"><i class="fa fa-clock-o"></i> Riwayat</a>
              <a class="btn btn-primary btn-flat" data-toggle="modal" data-target="#myData"><i class="fa fa-plus"></i> Unit</a>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="right">
              <button class="btn btn-success btn-flat" type="submit" name="masuk" id="button-simpan" onmouseover="cekStok()"><i class="fa fa-sign-in"></i> Simpan</button>
            </div>           
          </div>
