      ...
      <div class="box-header">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
            <h3 class="box-title"><strong><i class="fa fa-search"></i> Cari Laporan Stok</strong></h3>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group has-feedback">
              <input type="text" class="form-control" id="datepicker" name="tanggal" placeholder="Pilih Tanggal" readonly="readonly" value="{{ $now }}" value="{{ old('tanggal') }}">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        ...
        <div class="box-body">
          <div id="report01">
          <p>*Lap. Stok Sentral {{ Carbon\Carbon::parse($tgl01)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw01 }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk01 }}</strong></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        <div class="box-header">
          ...
          <div class="row hidden-xs">
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6" align="left">
              <h3 class="box-title" style="color: #2146D0;"><strong><i class="fa fa-file-text"></i> Bisma BMM</strong></h3>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6" align="right">
        ...
        <div class="box-body">
          <div id="report02">
          <p>*Lap. Stok BMM {{ Carbon\Carbon::parse($tgl02)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw02 }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk02 }}</strong></p>
          </div>
        </div>
      </div>
  </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        ...
        <div class="box-body">
          <div id="report04">
          <p>*Lap. Stok UD {{ Carbon\Carbon::parse($tgl04)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw04 }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk04 }}</strong></p>
          </div>
        </div>
      </div>
    </div>
...
<!-- TTS =============================================================================== -->
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        ...
        <div class="box-body">
          <div id="report05">
          <p>*Lap. Stok TTS {{ Carbon\Carbon::parse($tgl05)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw05 }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk05 }}</strong></p>
          </div>
        </div>
      </div>
  </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        ...
        <div class="box-body">
          <div id="report06">
          <p>*Lap. Stok Imbo {{ Carbon\Carbon::parse($tgl06)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw06 }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk06 }}</strong></p>
          </div>
        </div>
      </div>
    </div>
...
<!-- MANDIRI =============================================================================== -->
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        ...
        <div class="box-body">
          <div id="report07">
          <p>*Lap. Stok Mandiri {{ Carbon\Carbon::parse($tgl07)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw07 }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk07 }}</strong></p>
          </div>
        </div>
      </div>
  </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        ...
        <div class="box-body">
          <div id="report08">
          <p>*Lap. Stok WR Supratman {{ Carbon\Carbon::parse($tgl08)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw08 }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk08 }}</strong></p>
          </div>
        </div>
      </div>
    </div>
...
<!-- Sunset Road =============================================================================== -->
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        ...
        <div class="box-body">
          <div id="report09">
          <p>*Lap. Stok Sunset {{ Carbon\Carbon::parse($tgl09)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw09 }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk09 }}</strong></p>
          </div>
        </div>
      </div>
  </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="box">
        ...
        <div class="box-body">
          <div id="report04F">
          <p>*Lap. Stok FSS {{ Carbon\Carbon::parse($tgl04F)->format('d-m-Y') }}*</p>
          <!-- STOK AWAL -->
          <p><strong>Stok Awal : {{ $SAw04F }}</strong></p>
          <hr>
          ...
          <!-- STOK AKHIR -->
          <p><strong>Stok Akhir : {{ $SAk04F }}</strong></p>
          </div>
        </div>
      </div>
  </div>
