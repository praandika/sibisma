        ...
        <div class="box-body">
          ...
          <div class="row hidden-xs">
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
              <a class="btn btn-flat btn-info" href="{{ URL('opname/riwayat',$home) }}"><i class="fa fa-clock-o"></i> Riwayat</a>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="right">
              <button class="btn btn-flat btn-success" type="submit" name="simpan" id="button-simpan"><i class="fa fa-check"></i> Simpan</button>
            </div>           
          </div>
