          ...
          <div class="table-responsive">
        	...
        	<table id="myTable" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  @if((Session::get('akses') == "super") OR (Session::get('akses') == "admin"))
                  <td>
                    <abbr title="Edit"><a class="btn btn-primary" data-toggle="modal" data-target="#myEdit{{ $o->id_unit }}"><i class="fa fa-pencil"></i></a></abbr> 
                  </td>
                  @endif
                </tr>
                @endforeach
  ...
  <div class="col-xs-12 col-lg-6">
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-lg-6" align="left">
               <button class="btn btn-success" data-toggle="modal" data-target="#myWarna"><i class="fa fa-plus"></i> Tambah</button>
            </div>
          </div>
         <br><br>
          @endif
          ...
          <table id="myTable" class="table table-bordered table-striped table-hover">
            <thead>
                ...
                <tr>
                  ...
                  @if((Session::get('akses') == "super") OR (Session::get('akses') == "admin"))
                  <td>
                    <abbr title="Edit"><a class="btn btn-primary" data-toggle="modal" data-target="#myEdit{{ $o->id_warna }}"><i class="fa fa-pencil"></i></a></abbr> 
                  </td>
                  @endif
                </tr>
                @endforeach
...
@foreach($warna as $o)
<!-- Modal Edit Unit -->
<div class="modal fade" id="myEdit{{ $o->id_warna }}" tabindex="-1" aria-labelledby="myModalLabel" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <!-- Header Modal -->
      <div class="modal-header">
