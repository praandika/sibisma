        ...
        <div class="box-body">
          ...
          <div class="row hidden-xs">
            <div class="col-lg-6 col-md-6 col-sm-6" align="left">
               <button class="btn btn-flat btn-success" data-toggle="modal" data-target="#myData"><i class="fa fa-plus"></i> Tambah</button>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6" align="right">
               <a href="{{ URL('report/stok/excel',$home) }}" class="btn btn-flat btn-success"><i class="fa fa-file-excel-o"></i> Export Excel</a>
               <a href="{{ URL('report/stok/print',$home) }}" class="btn btn-flat btn-primary"><i class="fa fa-print"></i> Cetak</a>
            </div>
          </div>
