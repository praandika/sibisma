...
class OutController extends Controller
{
    public function keluar($tgl = null, $home = null){
    	if (!Session::get('login')) {
        	...
        	->sum('qty_out');
        	return view('out.keluar',compact('title','dealer','data','keluar','warna','now','total','tgl','unit','stok','home'));
        }
    }
...
// RIWAYAT-------------------------------------------------------------------
    public function Riwayat($home = null){
        if (!Session::get('login')) {
            ...
            ->sum('qty_out');
            return view('out.riwayat',compact('title','dealer','keluar','now','total','tgl','grandTotal','home'));
        }
    }
