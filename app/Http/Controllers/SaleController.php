...
class SaleController extends Controller
{
    public function sale($tgl = null, $home = null){
    	if (!Session::get('login')) {
        	...
        	->sum('qty');
        	return view('sale.jual',compact('title','dealer','data','jual','warna','now','total','tgl','unit','stok','home','leasing'));
        }
    }
...
// RIWAYAT ===========================================================================
    public function Riwayat($home = null){
        if (!Session::get('login')) {
            ...
            ->sum('qty');
            return view('sale.riwayat',compact('title','dealer','jual','now','total','tgl','grandTotal','home'));
        }
    }
