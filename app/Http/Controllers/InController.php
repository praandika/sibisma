...
class InController extends Controller
{
    ...
    public function masuk($tgl = null, $home = null){
    	if (!Session::get('login')) {
        	...
        	->sum('qty_in');
        	return view('in.masuk',compact('title','dealer','data','masuk','warna','now','total','tgl','unit','stok','home'));
        }
    }
...
// DELETE ===============================================================================
    ...
    public function Riwayat($home = null){
    	if (!Session::get('login')) {
        	...
        	->sum('qty_in');
        	return view('in.riwayat',compact('title','dealer','masuk','now','total','tgl','grandTotal','home'));
        }
    }
