...
class StokOpnameController extends Controller
{
    public function opname($tgl = null, $home = null){
    	if (!Session::get('login')) {
        	...
        	return view('opname.data',compact('title','dealer','data','opname','warna','now','unit','stok','home'));
        }
    }
...
// RIWAYAT ===========================================================================
    public function Riwayat($home = null){
        if (!Session::get('login')) {
            ...
            return view('opname.riwayat',compact('title','dealer','opname','now','tgl','home'));
        }
    }
}
